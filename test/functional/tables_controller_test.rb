...
class TablesControllerTest < ActionController::TestCase
  ...
  test "should create table" do
    assert_difference('Table.count') do
      post :create, table: { admin: @table.admin, ipaddress: @table.ipaddress, macaddress: @table.macaddress, name: @table.name }
    end
  ...
  test "should update table" do
    put :update, id: @table, table: { admin: @table.admin, ipaddress: @table.ipaddress, macaddress: @table.macaddress, name: @table.name }
    assert_redirected_to table_path(assigns(:table))
  end
